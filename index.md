...
<section class="hero">
  <div class="shell hero-grid">
    ...
    <div class="hero-card">
      ...
      <div class="metric"><span>Duplicate URLs cleaned</span><strong>Unique list</strong></div>
      <div class="metric"><span>Page metadata</span><strong>CSV / XLSX</strong></div>
      <div class="metric"><span>Processing</span><strong>Scrapebox</strong></div>
      <div class="metric"><span>Delivery</span><strong>Private link</strong></div>
    </div>
  </div>
</section>
...
<section class="section alt">
  <div class="shell">
    <div class="section-heading"><div><span class="eyebrow">How it works</span><h2>Simple from input to report</h2></div></div>
    <div class="steps">
      <div class="card"><span class="step-number">01 / SEND</span><h3>Choose a tool</h3><p>Tell us what you want to analyze and upload a plain-text URL list when needed.</p></div>
      <div class="card"><span class="step-number">02 / PROCESS</span><h3>Run the workflow</h3><p>Scrapebox processes the list on the offline workstation.</p></div>
      <div class="card"><span class="step-number">03 / REVIEW</span><h3>Quality check</h3><p>Results are checked for counts, structure, and missing values.</p></div>
      <div class="card"><span class="step-number">04 / DELIVER</span><h3>Get your report</h3><p>Receive a private download link for the finished export.</p></div>
    </div>
  </div>
</section>
